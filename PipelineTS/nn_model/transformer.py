...
class TransformerModel(DartsForecastMixin, NNModelMixin, IntervalEstimationMixin):
    ...
    def fit(self, data, cv=5, convert_dataframe_kwargs=None, fit_kwargs=None):
        """
        Fit the TransformerModel on the input data.
    ...
    def predict(self, n, data=None, predict_kwargs=None, convert_dataframe_kwargs=None):
        """
        Make predictions using the fitted TransformerModel.
        ...
        data : pd.DataFrame or None, optional, default: None
            The input data for prediction in pandas DataFrame format. If None, uses the training data.
