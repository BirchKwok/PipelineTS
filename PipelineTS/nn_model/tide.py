...
class TiDEModel(NNForecastingMixin):
    def __init__(
        ...
        num_encoder_layers : int, optional, default: 2
            The number of encoder layers.
        num_decoder_layers : int, optional, default: 2
            The number of decoder layers.
        hidden_size : int, optional, default: 128
            The hidden dimension.
        decoder_output_dim : int, optional, default: 16
            The decoder output dimension per step.
        temporal_decoder_hidden : int, optional, default: 32
            The temporal decoder hidden size.
