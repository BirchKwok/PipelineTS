from PipelineTS.models.nn.backbones import StackingRNN

from PipelineTS.models.nn._wrapper import NNBackboneForecastingMixin


class StackingRNNModel(NNBackboneForecastingMixin):
    def __init__(
            self,
            time_col,
            target_col,
