import numpy as np
import pandas as pd
from PipelineTS.preprocessing import split_series, lag_splits, split_series_multivariate, split_series_panel, lag_splits_panel
...
class NNForecastingMixin(NNModelMixin, IntervalEstimationMixin):
    """
    NNForecastingMixin: A mixin class for integrating neural network models into PipelineTS.
    ...
    Examples
    --------
    # Instantiate NNForecastingMixin
    >>> nn_model = NNForecastingMixin(time_col='timestamp', target_col='value', accelerator='auto')
    """
...
class MultivariateNNForecastingMixin(NNModelMixin, IntervalEstimationMixin):
...
class MLForecastingMixin:
    """PipelineTS ml model mixin class"""
    ...
