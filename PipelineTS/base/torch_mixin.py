...
from PipelineTS.metrics import WMAPELoss, RMSELoss
from PipelineTS.utils import seed_everything, check_is_fitted
...
class TorchModelMixin:
    ...
    def call(self, *args, **kwargs):
        ...
        """
        raise NotImplementedError("To implement a PipelineTS nn backbone class, you must implement a call function.")
    ...
    def _enable_cqr(self, alpha=0.1):
        ...
        """
        from PipelineTS.metrics import CombinedQuantileLoss
